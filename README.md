...
- **Frontend:** React, Next.js, TypeScript, Tailwind, shadcn/ui, Vite, Micro Frontends (Webpack Module Federation)
- **Backend:** Node.js, Express, Next.js server actions, REST APIs, JWT, Better Auth, WebSockets
- **Databases:** PostgreSQL (Neon), Drizzle ORM, Redis
- **AI / LLM:** Claude API, OpenAI, OpenRouter, MCP, Structured Outputs, Vision models (Gemini), ElevenLabs
- **DevOps / Tools:** Docker, Vercel, Git, Postman, Playwright, JMeter
...
Software Engineer @ EXC Managed Services — building a student retention platform with AI-driven dropout prediction, on a 24-MFE architecture.

---

## 📫 Reach me

[Email](mailto:devanshigarg2002@gmail.com) · [Portfolio](https://devanshi-portfolio-five.vercel.app) · [LinkedIn](https://www.linkedin.com/)
